 ...
 */
angular.module('contactIntegration.setupInstruction.InStar', ['ui.router'])
/**
...
.config(function config($stateProvider) {
    ...
    $stateProvider.state('setupInstruction.InStar', {
        ...
        data: {
            pageTitle: 'InStar Setup Instruction'
        }
    });
})
/**
 ...
 */
.controller('InStarSetupInstructionCtrl', function($scope, $state) {
