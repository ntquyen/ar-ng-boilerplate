 ...
 */
angular.module('contactIntegration.setupInstruction.Epic', ['ui.router'])
/**
...
.config(function config($stateProvider) {
    ...
    $stateProvider.state('setupInstruction.Epic', {
        ...
        data: {
            pageTitle: 'Epic Setup Instruction'
        }
    });
})
/**
 ...
 */
.controller('EpicSetupInstructionCtrl', function($scope, $state) {
