 ...
 */
angular.module('contactIntegration.setupInstruction.FSC', ['ui.router'])
/**
...
.config(function config($stateProvider) {
    ...
    $stateProvider.state('setupInstruction.FSC', {
        ...
        data: {
            pageTitle: 'FSC Setup Instruction'
        }
    });
})
/**
 ...
 */
.controller('FSCSetupInstructionCtrl', function($scope, $state) {
