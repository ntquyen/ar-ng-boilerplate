 ...
 */
angular.module('contactIntegration.setupInstruction.Vision', ['ui.router'])
/**
...
.config(function config($stateProvider) {
    ...
    $stateProvider.state('setupInstruction.Vision', {
        ...
        data: {
            pageTitle: 'Vision Setup Instruction'
        }
    });
})
/**
 ...
 */
.controller('VisionSetupInstructionCtrl', function($scope, $state) {
