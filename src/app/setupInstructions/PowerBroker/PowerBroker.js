 ...
 */
angular.module('contactIntegration.setupInstruction.PowerBroker', ['ui.router'])
/**
...
.config(function config($stateProvider) {
    ...
    $stateProvider.state('setupInstruction.PowerBroker', {
        ...
        data: {
            pageTitle: 'PowerBroker Setup Instruction'
        }
    });
})
/**
 ...
 */
.controller('PowerBrokerSetupInstructionCtrl', function($scope, $state) {
