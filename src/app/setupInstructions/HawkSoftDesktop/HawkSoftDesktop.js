 ...
 */
angular.module('contactIntegration.setupInstruction.HawkSoftDesktop', ['ui.router'])
/**
...
.config(function config($stateProvider) {
    ...
    $stateProvider.state('setupInstruction.HawkSoftDesktop', {
        ...
        data: {
            pageTitle: 'HawkSoftDesktop Setup Instruction'
        }
    });
})
/**
 ...
 */
.controller('HawkSoftDesktopSetupInstructionCtrl', function($scope, $state) {
