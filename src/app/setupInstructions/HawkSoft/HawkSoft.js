 ...
 */
angular.module('contactIntegration.setupInstruction.HawkSoft', ['ui.router'])
/**
...
.config(function config($stateProvider) {
    ...
    $stateProvider.state('setupInstruction.HawkSoft', {
        ...
        data: {
            pageTitle: 'HawkSoft Setup Instruction'
        }
    });
})
/**
 ...
 */
.controller('HawkSoftSetupInstructionCtrl', function($scope, $state) {
