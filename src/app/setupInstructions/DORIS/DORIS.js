 ...
 */
angular.module('contactIntegration.setupInstruction.DORIS', ['ui.router'])
/**
...
.config(function config($stateProvider) {
    ...
    $stateProvider.state('setupInstruction.DORIS', {
        ...
        data: {
            pageTitle: 'DORIS Setup Instruction'
        }
    });
})
/**
 ...
 */
.controller('DORISSetupInstructionCtrl', function($scope, $state) {
