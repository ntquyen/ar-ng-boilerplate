angular.module('agencyLocation', ['fakeApi']).factory('agencyLocationApi', ['$http', 'fakeApiService',
    function($http, fakeApiService) {
        return {
            ...
            getAgencyLocations: function() {
                ...
                /*
                return $http.get('/desktopmodules/AgencyRevContactIntegrations/API/AgencyLocations/GetAll');
                */
            }
        };
    }
