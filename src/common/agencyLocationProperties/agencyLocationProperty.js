angular.module('agencyLocationProperty', ['fakeApi']).factory('agencyLocationPropertyApi', ['$http', 'fakeApiService',
        ...
        return {
            ...
            getAgencyLocationProperties: function(agencyLocationId) {
                ...
                if (agencyLocationId >= 0) {
                    return $http.get('/desktopmodules/AgencyRevContactIntegrations/API/AgencyLocationProperties/GetByAgencyLocationId?agencyLocationId=' + agencyLocationId);
                }
